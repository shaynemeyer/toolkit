...
// CreateDirIfNotExists creates a directory, and all necessary parent directories, if it doesn't already exist
...
// PushJSONToRemote posts arbitrary data to some URL as JSON, and returns a JSON response, status code and error, if any.
// The final parameter, client, is optional. If none is provided, we use the standard http.Client.
